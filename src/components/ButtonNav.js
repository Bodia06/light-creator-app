...
export default function ButtonNav () {
  ...
  if (!pathname) return <div>Loading nav components</div>
  return (
    <header className='flex items-center  w-full h-[90px] overflow-hidden bg-[#dddddd] z-[10]'>
      ...
      <nav className='w-[100%] h-[100%] flex z-[0]'>
        <ul className=' h-[100%] flex items-center gap-[70px] relative after:content-[""] after:border-[2px] after:border-solid after:w-[92%] after:absolute after:z-[-2]'>
          <li
            className={`${
              pathname === PATHNAME_VALUES.home
                ? 'bg-[#f1cb25]'
                : 'bg-[#b1b1b1]'
            } flex justify-center items-center relative h-[100%] w-[120px] font-[bold] after:content-[""] after:block after:w-[120px] after:h-[120px] after:bg-inherit after:rotate-45 after:absolute after:left-[30px] after:z-[-1]`}
          >
            <Link
          ...
          <li
            className={`flex flex-col h-full justify-end items-center gap-[2px]
              before:content-[""] before:block before:w-[10px] before:h-[10px] before:rounded-full translate-y-[-10%] ${
                pathname === PATHNAME_VALUES.rail
                  ? 'before:bg-[#f1cb25]'
                  : 'before:bg-[#000]'
              }`}
          >
          ...
          <li
            className={` flex flex-col h-full justify-end items-center gap-[2px] before:content-[""] before:block before:w-[10px] before:h-[10px] before:rounded-full translate-y-[-10%] ${
          ...
          <li
            className={` flex flex-col h-full justify-end items-center gap-[2px] before:content-[""] before:block before:w-[10px] before:h-[10px] before:rounded-full translate-y-[-10%] ${
              pathname === PATHNAME_VALUES.result
                ? 'before:bg-[#f1cb25]'
                : 'before:bg-[#000]'
            }`}
          >
