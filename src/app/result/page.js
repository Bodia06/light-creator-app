...
import { downloadPDF, downloadExcel } from '@/utils/downloads'
...
export default function Result () {
  ...
  const [selectedItemsBuilding, setSelectedItemsBuilding] = useState(false)
      ...
      {isOpeningContant ? (
        <div className='flex items-center justify-center w-full'>
          <div className='max-w-[1200px] w-full'>
            <div
              ref={contentRef}
              className='flex flex-col w-full gap-[10px] pt-[20px]'
            >
              <div>
              ...
              <div className='flex items-center w-full gap-[10px]'>
                ...
                <div
                  className={`w-[40px] h-[40px] border border-[#d7d7d7] ${
            ...
            <footer className='w-full flex justify-between items-center p-[20px]'>
              ...
              <div className='w-[40%] flex gap-[10px] justify-end'>
                <button
                  onClick={() => downloadExcel(selectedItems)}
                  className='text-[#fff] text-[15px] bg-[#000] border rounded-[10px] px-[20px] py-[10px] font-[bold] cursor-pointer'
                >
